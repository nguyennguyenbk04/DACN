...
\centering
{\Large \bfseries \MakeUppercase{Quizum: AI-powered Video
Summarization and Quiz generator
website}}    
...
\begin{tabular}[H]{r l l}
     \large \textbf{SUPERVISOR(s)} & : \large Assoc. Prof. QUAN THANH THO, Ph.D.\\

     \multicolumn{2}{c}{\textbf{\large ————o0o———–}}\\
     \large \textbf{STUDENT}& : \large NGUYEN BINH NGUYEN - 2252545\\
   
\end{tabular}    
\end{center}
\vspace{1.cm}
\begin{center}
{\fontsize{12pt}{0pt} HO CHI MINH CITY, Apr 2026}
\end{center}
\end{titlepage}
...
\setcounter{page}{1}
\include{instructor-signature/main.tex}
...
\include{theoretical-background/main}
\include{system/main}
\include{experiements/main}
\include{conclusion/main}

% \include{system-design/main.tex}
% \newpage
% \newpage
% \include{future-plan/main.tex}
% \newpage
