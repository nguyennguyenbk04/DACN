...
\begin{itemize}
    ...
    \item **AI Subsystems**:
        \begin{itemize}
            ...
            \item **Pegasus**: Generates abstractive summaries from the transcripts.
            \item **Flan-T5**: An instruction-tuned model utilized for generating multiple-choice questions (MCQs) from the content.
        \end{itemize}
\end{itemize}
